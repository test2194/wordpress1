<?php
	...
	$page_sidebar_layout = apply_filters('astore_page_sidebar_layout',astore_option('blog_sidebar_layout'));
...
<?php do_action('astore_before_page_wrap');?>
  <div class="container">
    <div class="page-inner row <?php echo $aside_class; ?>">
      <div class="col-main">
        <section class="post-main" role="main" id="content">
          <article class="post-entry text-left">
            <?php do_action('astore_before_post_content');?>
            <?php
				/* Start the Loop */
			...
			?>
            <?php do_action('astore_after_post_content');?>
      ...
      <?php astore_get_sidebar($page_sidebar_layout,'blog');?>
    </div>
  </div>
</div>
