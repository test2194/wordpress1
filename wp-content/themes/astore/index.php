<?php
	get_header();
	$blog_style = absint(astore_option( 'blog_list_style'));
	$page_sidebar_layout = apply_filters('astore_page_sidebar_layout',astore_option('blog_archives_sidebar_layout'));
