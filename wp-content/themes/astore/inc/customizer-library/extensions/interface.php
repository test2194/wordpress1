			...
			if ( isset( $option['type'] ) ) {
				...
				switch ( $option['type'] ) {
					...
					case 'iconpicker':
						...
						$wp_customize->add_control(
							new AStore_Customize_Iconpicker_Control(
								$wp_customize, $option['id'], $option
							)
						);
					...
					case 'radio-image':
						...
						$wp_customize->add_control(
							new AStore_Customize_Control_Radio_Image(
								$wp_customize, $option['id'], $option
							)
						);
					...
					case 'multiple-select':
						...
						$wp_customize->add_control(
							new AStore_Customize_Control_Multiple_Select(
								$wp_customize, $option['id'], $option
							)
						);
					...
					case 'multiple-checkbox':
						...
						$wp_customize->add_control(
							new AStore_Customize_Control_Checkbox_Multiple(
								$wp_customize, $option['id'], $option
							)
						);
					...
					case 'astore_editor':
						$wp_customize->add_control(
							new AStore_Customize_Editor_Control(
								$wp_customize, $option['id'], $option
							)
						);
					break;
