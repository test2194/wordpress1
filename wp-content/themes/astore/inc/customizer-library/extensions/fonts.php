...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'astore' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'astore' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'astore' ),
		'cyrillic'     => __( 'Cyrillic', 'astore' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'astore' ),
		'devanagari'   => __( 'Devanagari', 'astore' ),
		'greek'        => __( 'Greek', 'astore' ),
		'greek-ext'    => __( 'Greek Extended', 'astore' ),
		'khmer'        => __( 'Khmer', 'astore' ),
		'latin'        => __( 'Latin', 'astore' ),
		'latin-ext'    => __( 'Latin Extended', 'astore' ),
		'vietnamese'   => __( 'Vietnamese', 'astore' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'astore' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'astore' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'astore' ),
