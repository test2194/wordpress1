 ...
 * @access public
 */
class AStore_Customize_Control_Radio_Image extends WP_Customize_Control {
	/**
	...
	public function render_content() {
		...
		<div id="<?php echo esc_attr( "input_{$this->id}" ); ?>">
			...
			<?php foreach ( $this->choices as $value => $args ) : ?>
				<div class="radio-image-item <?php if($this->value() == $value){echo "selected";}?>" >
	...
	/>
		...
		<script type="text/javascript">
			jQuery( document ).ready( function($) {
				...
				$( document ).on( 'click', '.customize-control-radio-image .radio-image-item', function(){
					$( this ).parents('.customize-control-radio-image').find('.radio-image-item').removeClass('selected');
