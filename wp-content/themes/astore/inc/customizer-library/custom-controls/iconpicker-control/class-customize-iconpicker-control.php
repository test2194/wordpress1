...
add_action( 'customize_register', 'astore_iconpicker_customize_register' );
function astore_iconpicker_customize_register(){

	class AStore_Customize_Iconpicker_Control extends WP_Customize_Control {
