<?php
	function easyreservations_tinymce_tutorial() {
		...
		$handler = array('#type_select','#form_chooser', '#form_submit_message','#type_select', '#calendar_resource', '#calendar_monthesx');
		$content = array(
		...
		$execute = array('jQuery(\'#type_select\').attr(\'value\', \'form\');jumpto(\'form\');', '', 'jQuery(\'#type_select\').attr(\'value\', \'calendar\');jumpto(\'calendar\');', '', '', '');
		$nr = 6;
		...
		if(function_exists('easyreservations_send_search_callback')){
			...
			$execute[key($execute)] = 'jQuery(\'#type_select\').attr(\'value\', \'search\');jumpto(\'search\');';
			$execute[] = '';
		...
		if(function_exists('easyreservations_send_hourlycal_callback')){
			...
			$execute[key($execute)] .= 'jQuery(\'#type_select\').attr(\'value\', \'hourlycalendar\');jumpto(\'hourlycalendar\');';
			$execute[] = '';
			$nr++;
		}
