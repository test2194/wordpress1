 ...
 *
 * Usage:
 * $download_remote_image = new Vela_Download_Remote_Image( $url );
 * $attachment_id         = $download_remote_image->download();
 *
 */
class Vela_Download_Remote_Image {
	/**
	 * Remote image URL.
	 *
	 * @var string
	...
	private function sideload() {
		...
		$overrides = array(
			...
			'test_form'   => false,
			// Setting this to false lets WordPress allow empty files ¨C not recommended.
			'test_size'   => true,
