 ...
 */
class vela_Meta_Box_Show_Filters {
	...
	public static function check_id( $display, $meta_box ) {
		...
		$object_id = is_admin() ? vela_Meta_Box::get_object_id() : @get_the_id();
	...
	public static function check_page_template( $display, $meta_box ) {
		...
		$object_id = vela_Meta_Box::get_object_id();

		if ( ! $object_id || vela_Meta_Box::get_object_type() !== 'post' )
			return false;
